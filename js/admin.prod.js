(function($) {
    ...
    EA.ConnectionBulkView = Backbone.View.extend({
        ...
        // edit template
        template_edit : _.template( $("#ea-tpl-connection-bulk").html() ),
        template_bulk_connections: _.template( $("#ea-tpl-single-bulk-connection").html() ),
    ...
    EA.ConnectionsView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            if (typeof $.timepicker.regional[ea_settings.datepicker] !== 'undefined') {
                jQuery.timepicker.setDefaults( $.timepicker.regional[ea_settings.datepicker] );
            }
    ...
    //      this.render();
        ...
        updateMailTemplate: function() {
            ...
            var prevContent = tinymce.get('mail-template').getContent();
    ...
    EA.ToolsView = Backbone.View.extend({
        ...
        template : _.template( $("#ea-tpl-tools").html() ),
        template_error_log : _.template( $("#ea-tpl-tools-log").text() ),
