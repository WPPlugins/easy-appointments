...
<div class="ea-bootstrap" style="max-width: <%= settings.width %>;">
    <form class="form-horizontal">
            ...
            <div class="step form-group">
                ...
                <div class="col-sm-8">
                    <select name="location" data-c="location" class="filter form-control">
                        <?php $this->get_options("locations", $location_id) ?>
                    </select>
                </div>
            <label class="ea-label col-sm-4 control-label ea-rtl-label">
                <?php echo $this->options->get_option_value("trans.location")?>
            </label>
        </div>
        <div class="step form-group">
            <div class="block"></div>
            <div class="col-sm-8">
                <select name="service" data-c="service" class="filter form-control" data-currency="<?php echo $this->options->get_option_value("trans.currency");?>">
                    <?php $this->get_options("services", $service_id) ?>
                </select>
            </div>
            <label class="ea-label col-sm-4 control-label ea-rtl-label">
                <?php echo $this->options->get_option_value("trans.service") ?>
            </label>
        </div>
        <div class="step form-group">
            <div class="block"></div>
            <div class="col-sm-8">
                <select name="worker" data-c="worker" class="filter form-control">
                    <?php $this->get_options("staff", $worker_id) ?>
                </select>
            </div>
            <label class="ea-label col-sm-4 control-label ea-rtl-label">
                <?php echo $this->options->get_option_value("trans.worker") ?>
            </label>
        </div>
        ...
        <% } %>
            ...
            <% } %>
            <div class="form-group">
                <div class="col-sm-offset-4 col-sm-8" style="display: inline-flex;">
